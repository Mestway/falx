...
test_vtrace = [
      ...
      Line(x1='C', y1=3, x2='D', y2=4, size=None, color='beta', column=None), 
      Line(x1='D', y1=4, x2='E', y2=3, size=None, color='beta', column=None), 
      ...
      Line(x1='D', y1=2, x2='E', y2=2, size=None, color='gamma', column=None), 
      Line(x1='A', y1=2, x2='B', y2=2, size=None, color='alpha', column=None), 
      Line(x1='B', y1=2, x2='C', y2=3, size=None, color='alpha', column=None), 
      Line(x1='C', y1=3, x2='D', y2=3, size=None, color='alpha', column=None), 
      Line(x1='D', y1=3, x2='E', y2=4, size=None, color='alpha', column=None)]

class TestFalxInterface(unittest.TestCase):

    def test_line_chart(self):
        task = FalxTask(inputs=test_inputs, vtrace=test_vtrace)
